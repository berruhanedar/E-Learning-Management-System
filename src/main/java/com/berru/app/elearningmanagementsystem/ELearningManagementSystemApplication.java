...
public class ELearningManagementSystemApplication implements CommandLineRunner {

    private final Logger LOG = LoggerFactory.getLogger(ELearningManagementSystemApplication.class);
    ...
    public static void main(String[] args) {
        SpringApplication.run(ELearningManagementSystemApplication.class, args);
    }
